function Policy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to GoalSetter App.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GoalSetter App, accessible from{" "}
            <a
              href="https://mern-app-goalsetter.herokuapp.com"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://mern-app-goalsetter.herokuapp.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: victor.borsattobh@gmail.com</li>
      </ul>
    </>
  );
}
